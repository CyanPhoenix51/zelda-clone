...
func _switch_weapon(weapon_active: bool) -> void:
	if weapon_active:
...
func _cast_spell() -> void:
	if not attacking:
		# change the extra animation to spell casting
